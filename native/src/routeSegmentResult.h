...
struct RouteSegmentResult {
   ...
   public:
	...
	inline string getDestinationName(string lang, bool transliterate, vector<SHARED_PTR<RouteSegmentResult>> list, int routeInd) {
	...
	inline string getStreetName(string lang, bool transliterate, vector<SHARED_PTR<RouteSegmentResult>> list, int routeInd) {
	...
	inline string getRef(string lang, bool transliterate) {
		return object->getRef(lang, transliterate, isForwardDirection());
	}
	
	inline SHARED_PTR<RouteDataObject> getObjectWithShield(vector<SHARED_PTR<RouteSegmentResult>> list, int routeInd) {

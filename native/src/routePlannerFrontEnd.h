...
public:
    ...
    constexpr static int GPX_OSM_ADVANCED_POINTS_MATCH_ALGORITHM = 3;
    int GPX_SEGMENT_ALGORITHM = GPX_OSM_POINTS_MATCH_ALGORITHM; // TODO should be switchable from JNI
